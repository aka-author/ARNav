...
class App extends ArnavApp {
    ...
    afterRun() {
        ...
        this.createDoc();
        this.tocArea = new ArnavScrollArea(this, "tocArea");
        this.tocTree = new ArnavUiTocMultipage(this.tocArea, "tocTree", "sec1.3", this.loadOpenIds());
        this.tocArea.setHScrollState(this.loadTocScrollTop());
    }
