...
const ITYPE_UITOC_ENTRY  = "uitocentry";
const ITYPE_UITOC_SCROLL = "uitocscroll";
...
class ArnavUiToc extends ArnavUiControl {
    ...
    attempt(issue) {
        ...
        switch(op) {
            case "open": 
                issue.convert(ITYPE_UITOC_ENTRY, this.openEntry(id));
                break;
            case "close":
                issue.convert(ITYPE_UITOC_ENTRY, this.closeEntry(id));
                break;
        }
