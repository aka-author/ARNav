...
class ArnavUiToc extends ArnavUiControl {
    ...
    getDivEntryTitleClassName(entry) {
        let baseClassName = entry.hasWorkers() ? "divTocEntryNodeTitle" : "divTocEntryLeafTitle";
    ...
    attempt(issue) {
        ...
        switch(op) {
            case "open": 
                issue.setType("tocentry");
                issue.setPayload(this.openEntry(id));
                break;
            case "close":
                issue.setType("tocentry");
                issue.setPayload(this.closeEntry(id));
                break;
        }
...
class ArnavPageTocArea extends ArnavUiControl {
