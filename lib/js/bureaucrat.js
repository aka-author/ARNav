...
class ArnavBureaucrat {
	...
	getI18n() {
		return this.getProp("i18n");
	}

	setCurrLocalCode(localCode=undefined) {
		this.currLocalCode = localCode;
	}

	getCurrLocalCode() {
		return this.getProp("currLocalCode");
	}
	...
	getMetaContent(metaName) {
		return this.hasChief() ? this.getChief().getMetaContent(metaName) : undefined;
	} 
