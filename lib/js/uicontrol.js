...
class ArnavUIControl extends ArnavDOMControl {
    ...
    hasCssClass(cssClassName) {
        return ArnavDOMUtils.hasCssClass(this.getDOMObject(), cssClassName);
    }

    addCssClass(cssClassName) {
        ArnavDOMUtils.addCssClass(this.getDOMObject(), cssClassName);
        return this;
    }

    removeCssClass(cssClassName) {
        ArnavDOMUtils.removeCssClass(this.getDOMObject(), cssClassName);
        return this;
    }

    toggleCssClass(cssClassName) {
        ArnavDOMUtils.toggleCssClass(this.getDOMObject(), cssClassName);
        return this;
    }

    replaceCssClass(currentCssClassName, replacingCssClassName) {
        ArnavDOMUtils.replaceCssClass(this.getDOMObject(), currentCssClassName, replacingCssClassName);
        return this;
    }
